...
export const Register = () => {
  ...
  const extractError = (err) => {
    ...
    if (!data) return err.message || 'Ошибка регистрации';
  ...
  return (
    <div data-easytag="id3-src/components/Auth/Register.jsx" className="auth-page">
      <style>
        {`
          .auth-page { 
            display: grid; 
      ...
      <div className="card" role="region" aria-label="Форма регистрации">
        <div className="title">Регистрация</div>
        <div className="sub">Создайте аккаунт для сохранения проектов и истории редактирования.</div>
        ...
        <form onSubmit={onSubmit} noValidate>
          ...
          <div className="actions">
            <button className="btn" type="submit" disabled={loading}>{loading ? 'Создаем…' : 'Создать аккаунт'}</button>
